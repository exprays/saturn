...
export const BotWindow = forwardRef<HTMLDivElement, Props>(
  (
    ...
    console.log(errors)
    return (
      <div className="h-[570px] w-[450px] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden">
          ...
          <TabsContent value="chat">
            ...
            <div className="flex flex-col h-full">
              <div
                ...
                className="px-3 flex h-[320px] flex-col py-5 gap-3 chat-window overflow-y-auto"
                ref={ref}
              >
                {chats.map((chat, key) => (
                  <Bubble
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  />
                  <Label htmlFor="bot-image" className="flex items-center ml-2">
                    <Paperclip />
                    <Input
                      {...register('image')}
                      type="file"
        ...
        <div className="flex justify-center mt-2">
          <p className="text-gray-400 text-xs">Powered By Saturn</p>
        </div>
      </div>
    )
  }
